                ...
                <div className="card-front">
                    <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back">
                            <li><a href="https://github.com/farhan-begg/mylife" className="fa fa-lg fa-linkedin"></a></li>
                            <li><a href="https://github.com/farhan-begg/mylife" className="fa fa-lg fa-github"></a></li>
                            <li><a href="https://github.com/farhan-begg/mylife" className="fa fa-modx"></a></li>
